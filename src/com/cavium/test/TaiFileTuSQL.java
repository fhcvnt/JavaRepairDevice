package com.cavium.test;
	...
	public class TaiFileTuSQL {

		protected Shell shell;
		// Chuỗi kết nối
		private String db_url = "jdbc:sqlserver://192.168.30.123;databaseName=QuaLySuaChuaThietBi;user=sa;password=Killua21608";
		...
		public static void main(String[] args) {
			try {
				TaiFileTuSQL window = new TaiFileTuSQL();
				window.open();
			} catch (Exception e) {
				e.printStackTrace();
			}
		...
		protected void createContents(int ngonngu) {
			...
			shell.setImage(SWTResourceManager.getImage(TaiFileTuSQL.class, "/repairdevice/Images/repair.ico"));
			...
			btnTaive.setImage(
					SWTResourceManager.getImage(TaiFileTuSQL.class, "/repairdevice/Images/download.png"));
			...
			try {
				...
				try {
					String select = "SELECT Ma_Form,Ten_Form,Ten_File,Ngay_Update FROM Phieu_De_Nghi";
				...
				public void widgetSelected(SelectionEvent e) {
					try {
						...
						try {
							...
							String select = "SELECT Ma_Form,Ten_Form,File_Code FROM Phieu_De_Nghi WHERE Ma_Form='"+maphieu+"'";
