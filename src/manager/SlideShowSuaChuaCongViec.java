...
public class SlideShowSuaChuaCongViec {
	...
	public static void main(String[] args) {
		try {
			SlideShowSuaChuaCongViec window = new SlideShowSuaChuaCongViec();
	...
	protected void createContents(int ngonngu,String chuoiketnoi) {
		db_url=chuoiketnoi;
		shell = new Shell();
		shell.setImage(SWTResourceManager.getImage(SlideShowSuaChuaCongViec.class, "/manager/Images/repair256.ico"));
